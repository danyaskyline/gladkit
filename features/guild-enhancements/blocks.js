// ============================================================================
// features/guild-enhancements/blocks.js
//
// Блоки наград = <h4> + содержимое до следующего <h4>.
// Работает по тем же правилам, что и в profile-enhancements/blocks.js,
// но конфиг берёт из GH.config.site.guild.
// ============================================================================
...
(function () {
    ...
    function isProtected(el) {
        const cfg = GH.config.site.guild;
    ...
    function collectBlocks(allowedTitles) {
        const headerSel = GH.config.site.guild.selectors.blockHeader;
        const rightPanelSel = GH.config.site.guild.selectors.rightPanel;
    ...
    GH.guildEnhancements.blocks = {
        collectBlocks: collectBlocks,
        attachToggles: attachToggles,
